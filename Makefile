...
liquid2: CN_Edge.cpp CN_Node.cpp CN_Graph.cpp test.cpp
	...
	# ./test_liquidity2 10 2
	# ./test_liquidity2 10 3
	# ./test_liquidity2 10 4
	# ./test_liquidity2 10 5
	# ./test_liquidity2 10 6
	./test_liquidity2 10 7
	# ./test_liquidity2 10 8
	# ./test_liquidity2 10 9
test:
	./test_liquidity 9 1
	./test_liquidity 9 2
	./test_liquidity 9 3
